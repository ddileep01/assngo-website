...
const FeedbackWidgetButton = ({ onClick }) => {
  return (
    <div
      onClick={onClick}
    ...
    >
      <div className="flex items-center justify-center">
        ...
        <span className="text-lg font-semibold text-green-950 hover:text-green-900 pl-2">Feedback</span>
      </div>
    </div>
  );
};

export default FeedbackWidgetButton;
